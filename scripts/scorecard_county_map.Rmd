...
## get state fips; change names; add leading zeros
...
insttypes <- list(list('pub2',c(5)),      # public two-years, group = 5
                  list('pub4',c(1,2)),    # public four-years, group = 1,2 
                  list('priv4',c(3,4)))   # private four-years, grour = 3,4
...
## =================================
## PRIVATE FOUR-YEAR MAP
## =================================

## read in spatial layer
mapname <- paste0(mdir, 'county_shape_', outcome, '_priv4_', year, '.geojson')  
county_shape <- readOGR(mapname, layer = 'OGRGeoJSON', verbose = FALSE)
